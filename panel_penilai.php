			...
			<body>
				<div id="tulis">
					...
					<div>
						...
						<?php
	  include "koneksi.php";
	  $hasil  = mysqli_query($koneksi, "SELECT a.kode2, a.nama_jabatan, b.nama_palru FROM tbl_jabatan a, tbl_pangkat_golru b WHERE a.id_jabatan=".$_SESSION['jab']." AND b.id_palru=".$_SESSION['pal']."");
	  if (!$hasil)
		...
		<div id="sidebar_kiri">
			...
			<div id="sidebar_title">
				...
				<div id="sidebar_isi">
					<ul>
						<li>
							<h3>Sebagai <?php echo $_SESSION['level']; ?></h3>
						</li>
