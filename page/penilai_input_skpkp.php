...
<div id="content">
	...
	<?php
	  ...
	  $hasil  = mysqli_query($koneksi, "select a.kode2, a.nama_jabatan, b.nama_palru from tbl_jabatan a, tbl_pangkat_golru b
	  ...
	  $hasil_lagi  = mysqli_query($koneksi, "select a.nip, a.nama_pns, c.nama_palru, b.nama_jabatan, a.unit_kerja, a.jekel, a.tmt, a.level
...
<?php
	include "../koneksi.php";
	  ...
	  $hasil2  = mysqli_query($koneksi, "select * from tbl_jabatan where id_jabatan=".$_SESSION['jab']."");
	  //$hasil  = mysqli_query("select nama_jabatan from tbl_jabatan where id_jabatan=13");
	  if (!$hasil2)
		die("Gagal Query data karena : ".mysqli_error());
		
	  if($row = mysqli_fetch_array($hasil2))
	    $hasil  = mysqli_query($koneksi, "select a.nip, a.nama_pns, c.nama_palru, b.nama_jabatan, a.unit_kerja, a.jekel, a.tmt, a.level
			       from tbl_pns a, tbl_jabatan b, tbl_pangkat_golru c
